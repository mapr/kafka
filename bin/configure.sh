...
KAFKA_HOME=${MAPR_HOME}/kafka/kafka-2.6.1/
KAFKA_CONNECT_HOME=${MAPR_HOME}/kafka-connect*/kafka-connect*
KAFKA_CONNECT_HDFS_HOME=${MAPR_HOME}/kafka-connect-hdfs/kafka-connect-hdfs-6.0.0/
KAFKA_CONNECT_JDBC_HOME=${MAPR_HOME}/kafka-connect-jdbc/kafka-connect-jdbc-6.0.0/
...
KAFKA_CONNECT_RESTART_SRC=${KAFKA_CONNECT_RESTART_SRC:-${MAPR_RESTART_SCRIPTS_DIR}/kafka-connect-6.0.0.restart}
