...
public class WrappingStoreProviderTest {
    ...
    public void before() {
        ...
        stubProviderOne.addStore("kv", StateStoreTestUtils.newKeyValueStore("kv", "app-id", "/stream1", String.class, String.class));
        stubProviderOne.addStore("window", new NoOpWindowStore());
        stubProviderTwo.addStore("kv", StateStoreTestUtils.newKeyValueStore("kv", "app-id", "/stream1", String.class, String.class));
