...
public class StreamsResetter {
    ...
    public int run(final String[] args,
        ...
        try {
            ...
            exitCode = maybeResetInputAndSeekToEndIntermediateTopicOffsets(consumerConfig, adminClient, dryRun, internalStreamCompacted);

            deleteAppDir(adminClient, dryRun, internalStream, internalStreamCompacted, appDir);
    ...
    private void maybeDeleteActiveConsumers(final String streamName,
    ...
    private int maybeResetInputAndSeekToEndIntermediateTopicOffsets(final Map consumerConfig,
                                                                    ...
                                                                    final String streamForCliSideAssignment)
    ...
    public void resetToDatetime(final Consumer<byte[], byte[]> client,
        ...
        for (final TopicPartition topicPartition : inputTopicPartitions) {
            final Optional<Long> partitionOffset = Optional.ofNullable(topicPartitionsAndOffset.get(topicPartition))
                    ...
                    .filter(offset -> offset != ListOffsetResponse.UNKNOWN_OFFSET);
    ...
    private void deleteAppDir(final Admin adminClient, final boolean dryRun, String internalStream, String internalStreamCompacted, String appDir) {
