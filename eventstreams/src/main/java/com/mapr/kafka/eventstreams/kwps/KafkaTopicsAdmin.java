...
public class KafkaTopicsAdmin implements AutoCloseable {
  ...
  public Iterable<KBrokerDescriptor> listBrokers() throws IOException {
    return listBrokers(Optional.empty());
  }

  public Iterable<KBrokerDescriptor> listBrokers(Optional<String> kafkaCluster) throws IOException {
